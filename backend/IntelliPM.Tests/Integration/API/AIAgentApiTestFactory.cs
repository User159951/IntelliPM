...
/// <summary>
/// WebApplicationFactory for AI agent API integration tests.
/// Extends CustomWebApplicationFactory and adds IChatCompletionService mocking.
/// </summary>
public class AIAgentApiTestFactory : WebApplicationFactory<Program>
{
    protected override void ConfigureWebHost(IWebHostBuilder builder)
    {
        ...
        builder.ConfigureServices(services =>
        {
            ...
            {
                options.UseInMemoryDatabase($"AIAgentTestDb_{Guid.NewGuid()}");
            });
            ...
            {
                options.UseInMemoryDatabase($"AIAgentTestVectorDb_{Guid.NewGuid()}");
            });
            ...
            var kernelDescriptors = services
                ...
                .ToList();
            foreach (var descriptor in kernelDescriptors)
            {
            ...
            // Create a mock IChatCompletionService
            ...
            // Register mock IChatCompletionService BEFORE Kernel
            services.AddSingleton<IChatCompletionService>(mockChatCompletion.Object);

            // Register Kernel with mock service - this will override the one from Program.cs
            services.AddSingleton<Kernel>(serviceProvider =>
            {
                var kernelBuilder = Kernel.CreateBuilder();
                // The mock IChatCompletionService is already registered, Kernel will use it
                var mockService = serviceProvider.GetRequiredService<IChatCompletionService>();
...
Proposed sprint plan balances team capacity with priority tasks. All tasks align with sprint goal.";
        ...
        else if (userMessage.Contains("improve", StringComparison.OrdinalIgnoreCase) || userMessage.Contains("task", StringComparison.OrdinalIgnoreCase))
        {
            return @"**Improved Task Description:**

**Title:** Implement user authentication system

**Description:**
Develop a secure authentication system that supports:
...
4. Sessions are managed properly
5. Password reset flow is implemented
