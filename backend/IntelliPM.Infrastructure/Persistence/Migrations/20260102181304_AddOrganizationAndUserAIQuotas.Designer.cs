...
namespace IntelliPM.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260102181304_AddOrganizationAndUserAIQuotas")]
    partial class AddOrganizationAndUserAIQuotas
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("IntelliPM.Domain.Entities.OrganizationAIQuota", b =>
                {
                    b.HasOne("IntelliPM.Domain.Entities.Organization", "Organization")
                        .WithOne()
                        .HasForeignKey("IntelliPM.Domain.Entities.OrganizationAIQuota", "OrganizationId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("IntelliPM.Domain.Entities.UserAIQuota", b =>
                {
                    ...
                    b.HasOne("IntelliPM.Domain.Entities.User", "User")
                        .WithOne()
                        .HasForeignKey("IntelliPM.Domain.Entities.UserAIQuota", "UserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
