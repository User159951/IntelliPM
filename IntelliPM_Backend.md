...
```
IntelliPM.API/
├── Controllers/                   # API controllers (38 active controllers, 8 admin controllers)
...
- **TaskQualityPlugin**: Evaluates task quality
...
| `AgentsController` | AI agents | Run agents (product, delivery, manager, QA, business), store notes |
| `AgentController` | AI agent operations | Analyze project, detect risks, plan sprint, metrics, audit logs |
...
| `TestController` | Testing | Test endpoints (development only) |
...
**Total Controllers:** 38 active controllers

| Controller | Route Pattern | Endpoints | Status |
|------------|---------------|-----------|--------|
| `ProjectsController` | `/api/v1/Projects` | 11 | ✅ Documented |
| `TasksController` | `/api/v1/Tasks` | 8 | ✅ Documented |
| `SprintsController` | `/api/v1/Sprints` | 7 | ✅ Documented |
...
| `AuthController` | `/api/v1/Auth` | 5 | ✅ Documented |
...
| `AgentsController` | `/api/v1/projects/{id}/agents` | 5 | ✅ Documented |
| `AgentController` | `/api/v1/Agent` | 5 | ✅ Documented |
...
| `MilestonesController` | `/api/v1/Milestones` | 8 | ✅ Documented |
| `ReleasesController` | `/api/v1/Releases` | 17 | ✅ Documented |
| `TestController` | `/api/v1/Test` | 1 | ⚠️ Development only |
