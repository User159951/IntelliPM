...
export interface paths {
    ...
    "/api/v1/Health/smtp/send-test": {
        ...
        post: {
            ...
            requestBody?: {
                content: {
                    "application/json; version=1.0": components["schemas"]["IntelliPM.API.Controllers.HealthController.SendTestEmailRequest"];
                    "text/json; version=1.0": components["schemas"]["IntelliPM.API.Controllers.HealthController.SendTestEmailRequest"];
                    "application/*+json; version=1.0": components["schemas"]["IntelliPM.API.Controllers.HealthController.SendTestEmailRequest"];
                };
            };
            responses: {
...
export interface components {
    schemas: {
        ...
        /** @description Request model for send-test email endpoint */
        "IntelliPM.API.Controllers.HealthController.SendTestEmailRequest": {
            to?: string;
        };
