        ...
        <SidebarInset>
          ...
          <div className="flex items-center justify-between border-b border-border bg-muted/40 px-6 py-2 text-xs text-muted-foreground">
            <div className="flex items-center gap-2 font-medium text-foreground">
              <span className="rounded-full bg-primary/10 px-2 py-0.5 text-[11px] text-primary">Admin Area</span>
              <span className="text-muted-foreground">Manage global settings & permissions</span>
            </div>
          </div>
